...
const CACHE_NAME = 'vila-mlynica-v3';
const STATIC_CACHE = 'vila-mlynica-static-v3';
const DYNAMIC_CACHE = 'vila-mlynica-dynamic-v3';
const IMAGE_CACHE = 'vila-mlynica-images-v3';
